...
export default function ProfileFetcher() {
  ...
  return (
    <div className="p-4 md:p-6 min-h-screen bg-gradient-to-br from-slate-900 to-slate-800 text-white">
      <div className="max-w-6xl mx-auto space-y-4">
        <h1 className="text-3xl font-bold text-center">Coding Profile Viewer</h1>

        {/* Personal info shown always */}
        <Card className="bg-slate-800/90 text-white border border-slate-600 shadow-md rounded-lg">
            ...
            <div className="flex flex-col md:flex-row items-center gap-6">
              ...
              <div className="text-center md:text-left">
                ...
                <div className="flex flex-wrap gap-4 mt-2 justify-center md:justify-start">
                  <span className="flex items-center text-sm text-gray-200 bg-white/5 px-3 py-1 rounded-full">
        ...
        <div className="flex flex-col sm:flex-row gap-2 mt-4">
          <select
            className="bg-slate-900 text-white rounded-md p-2 border border-slate-600 focus:ring-2 focus:ring-blue-400 focus:outline-none"
            value={platform}
          ...
          <Input
            className="bg-slate-900 border border-slate-600 text-white flex-grow placeholder:text-slate-400 focus:ring-2 focus:ring-blue-400 focus:border-transparent rounded-md px-3 py-2"
        ...
        {error && <p className="text-red-400 text-center py-4 font-medium">{error}</p>}
